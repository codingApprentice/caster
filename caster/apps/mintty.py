...
class CMDRule(MergeRule):
    ...
    mapping = {
		...
		"open Sikuli folder":   R(Text(r"cd /c/Users/barry/AppData/Roaming/Sikulix/Lib")+Key("enter"), rdescript="git bash: Go To MacroSystem"),
		
		
		#github commands
		"push origin master": R(Text("git push origin master")+Key("enter"), rdescript="git bash: push to the origin of the master"),
		"push origin": R(Text("git push origin "), rdescript="git bash: push to the origin"),
		"check out": R(Text("git checkout "), rdescript="git bash: check out"),
		"check out master": R(Text("git checkout master"), rdescript="git bash: check out master"),
